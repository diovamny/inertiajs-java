...
> permanent concurrency regression suite plus the `reactive-stress`
> profile; graduation completes with the Fase F fixes + full E2E matrix
> (see Compatibility policy).
