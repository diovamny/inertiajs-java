import { A as useMounted, B as useTimeoutFn, C as useForwardExpose, D as onKeyStroke, E as injectConfigProviderContext, F as isClient, H as getActiveElement, I as isIOS, L as refAutoReset, M as createEventHook, N as createGlobalState, O as unrefElement, P as createSharedComposable, R as tryOnBeforeUnmount, S as useForwardProps, T as useDirection, U as createContext, V as isNullish, W as cva, a as useVModel$1, b as useId, c as cn, g as useCollection, h as VisuallyHidden_default, i as useMediaQuery, j as useVModel, k as useEventListener, l as toUrl, n as defaultDocument, o as reactiveOmit, r as useEventListener$1, s as Button_default, t as createLucideIcon, u as RovingFocusGroup_default, v as Primitive, w as useEmitAsProps, x as useForwardPropsEmits, y as Presence_default, z as tryOnScopeDispose } from "./createLucideIcon.js";
import { $t as openBlock, Bt as nextTick, Dn as watch, Fn as withMemo, G as Fragment, L as vShow, Lt as mergeDefaults, Mn as withCtx, On as watchEffect, Pn as withDirectives, Qn as onScopeDispose, R as withKeys, Sr as router, Wn as getCurrentScope, Y as Teleport, Yn as isRef, Zt as onUnmounted, _ as TransitionGroup, _r as normalizeProps, an as renderList, ar as shallowReadonly, at as createElementBlock, dr as toValue$1, dt as createTextVNode, f as usePage, ft as createVNode, gn as toHandlers, gr as normalizeClass, it as createCommentVNode, kn as watchPostEffect, ln as resolveDynamicComponent, mt as defineComponent, nr as readonly, nt as createBaseVNode, o as link_default, on as renderSlot, or as shallowRef, pr as unref, qt as onMounted, rr as ref, rt as createBlock, tr as reactive, tt as computed, ur as toRefs, vr as normalizeStyle, wt as guardReactiveProps, yr as toDisplayString, z as withModifiers, zt as mergeProps } from "./dist.js";
import { n as useAppearance } from "./useAppearance.js";
...
var CollapsibleContent_default$1 = /* @__PURE__ */ defineComponent({
	inheritAttrs: false,
...
var CollapsibleTrigger_default$1 = /* @__PURE__ */ defineComponent({
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/building-2.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/contact-round.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/database.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/layers.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/navigation.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
* See the LICENSE file in the root directory of this source tree.
*/
var Navigation = createLucideIcon("NavigationIcon", [["polygon", {
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/radio.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/rectangle-ellipsis.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
//#endregion
//#region node_modules/lucide-vue-next/dist/esm/icons/wifi.js
/**
* @license lucide-vue-next v0.468.0 - ISC
*
* This source code is licensed under the ISC license.
...
var _hoisted_1$9 = { class: "flex h-full w-full flex-col" };
var _hoisted_2$5 = [
	"data-state",
	"data-collapsible",
	"data-variant",
			...
			return __props.collapsible === "none" ? (openBlock(), createElementBlock("div", mergeProps({
				...
				default: withCtx(() => [createVNode(unref(SheetContent_default), {
					...
					default: withCtx(() => [createVNode(SheetHeader_default, { class: "sr-only" }, {
						...
						_: 1
					}), createBaseVNode("div", _hoisted_1$9, [renderSlot(_ctx.$slots, "default")])]),
					_: 3
				}, 8, ["side", "style"])]),
				_: 3
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				class: normalizeClass(unref(cn)("flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Primitive), {
				...
				class: normalizeClass(unref(cn)("text-sidebar-foreground/70 ring-sidebar-ring flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium outline-hidden transition-[margin,opacity] duration-200 ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0", "group-data-[collapsible=icon]:-mt-8 group-data-[collapsible=icon]:opacity-0", props.class))
			}, {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 8, [
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("main", {
				...
				class: normalizeClass(unref(cn)("bg-background relative flex w-full flex-1 flex-col", "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-xl md:peer-data-[variant=inset]:shadow-sm md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
...
var SidebarMenuSub_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("ul", {
				...
				class: normalizeClass(unref(cn)("border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1 border-l px-2.5 py-0.5", "group-data-[collapsible=icon]:hidden", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
...
var SidebarMenuSubItem_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Button_default), {
				...
				default: withCtx(() => [unref(isMobile) || unref(state) === "collapsed" ? (openBlock(), createBlock(unref(PanelLeftOpen), { key: 0 })) : (openBlock(), createBlock(unref(PanelLeftClose), { key: 1 })), _cache[0] || (_cache[0] = createBaseVNode("span", { class: "sr-only" }, "Toggle Sidebar", -1))]),
				_: 1
			}, 8, ["class", "onClick"]);
		};
	}
...
var AppShell_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return __props.variant === "header" ? (openBlock(), createElementBlock("div", _hoisted_1$8, [renderSlot(_ctx.$slots, "default")])) : (openBlock(), createBlock(unref(SidebarProvider_default), {
				key: 1,
						...
						default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.items, (item) => {
							return openBlock(), createBlock(unref(SidebarMenuItem_default), { key: item.title }, {
								default: withCtx(() => [createVNode(unref(SidebarMenuButton_default), {
									...
									}, [(openBlock(), createBlock(resolveDynamicComponent(item.icon))), createBaseVNode("span", null, toDisplayString(item.title), 1)], 8, _hoisted_1$7)]),
									_: 2
								}, 1024)]),
								_: 2
							}, 1024);
...
//#endregion
//#region resources/js/components/ui/collapsible/Collapsible.vue
var Collapsible_default = /* @__PURE__ */ defineComponent({
	__name: "Collapsible",
	props: {
		defaultOpen: { type: Boolean },
		open: { type: Boolean },
	...
	setup(__props, { emit: __emit }) {
		const forwarded = useForwardPropsEmits(__props, __emit);
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(CollapsibleRoot_default), mergeProps({ "data-slot": "collapsible" }, unref(forwarded)), {
				default: withCtx((slotProps) => [renderSlot(_ctx.$slots, "default", normalizeProps(guardReactiveProps(slotProps)))]),
				_: 3
			}, 16);
		};
...
//#endregion
//#region resources/js/components/ui/collapsible/CollapsibleContent.vue
var CollapsibleContent_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const props = __props;
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(CollapsibleContent_default$1), mergeProps({ "data-slot": "collapsible-content" }, props), {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 16);
		};
...
//#endregion
//#region resources/js/components/ui/collapsible/CollapsibleTrigger.vue
var CollapsibleTrigger_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		const props = __props;
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(CollapsibleTrigger_default$1), mergeProps({ "data-slot": "collapsible-trigger" }, props), {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 16);
		};
...
function useCurrentUrl() {
	function isCurrentUrl(urlToCheck, currentUrl) {
		...
		if (!urlString.startsWith("http")) return urlString === urlToCompare;
		try {
...
//#endregion
//#region resources/js/components/NavCollapsible.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$6 = { class: "truncate" };
var _hoisted_2$4 = {
	key: 0,
	class: "ml-auto shrink-0 rounded bg-indigo-500/10 px-1 py-0.5 text-[9px] leading-none font-semibold text-indigo-500"
};
//#endregion
//#region resources/js/components/NavCollapsible.vue
var NavCollapsible_default = /* @__PURE__ */ defineComponent({
	__name: "NavCollapsible",
	props: { group: {} },
	setup(__props) {
		const props = __props;
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(SidebarMenuItem_default), null, {
				default: withCtx(() => [createVNode(unref(Collapsible_default), {
					"default-open": isGroupActive(),
					class: "group/collapsible"
				}, {
					default: withCtx(() => [createVNode(unref(CollapsibleTrigger_default), { "as-child": "" }, {
						default: withCtx(() => [createVNode(unref(SidebarMenuButton_default), { tooltip: __props.group.title }, {
							default: withCtx(() => [
								__props.group.icon ? (openBlock(), createBlock(resolveDynamicComponent(__props.group.icon), { key: 0 })) : createCommentVNode("", true),
								createBaseVNode("span", null, toDisplayString(__props.group.title), 1),
						...
						_: 1
					}), createVNode(unref(CollapsibleContent_default), null, {
						default: withCtx(() => [createVNode(unref(SidebarMenuSub_default), null, {
							default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(__props.group.items, (item) => {
								return openBlock(), createBlock(unref(SidebarMenuSubItem_default), { key: item.title }, {
									default: withCtx(() => [createVNode(unref(SidebarMenuSubButton_default), {
										"as-child": "",
										...
										default: withCtx(() => [createVNode(unref(link_default), {
											...
											default: withCtx(() => [createBaseVNode("span", _hoisted_1$6, toDisplayString(item.title), 1), item.badge ? (openBlock(), createElementBlock("span", _hoisted_2$4, toDisplayString(item.badge), 1)) : createCommentVNode("", true)]),
											_: 2
										}, 1032, ["href"])]),
										_: 2
									}, 1032, ["is-active"])]),
...
//#endregion
//#region resources/js/components/NavSection.vue
var NavSection_default = /* @__PURE__ */ defineComponent({
	__name: "NavSection",
	props: {
		section: {},
		items: {}
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(SidebarGroup_default), { class: "px-2 py-0" }, {
				default: withCtx(() => [createVNode(unref(SidebarGroupLabel_default), null, {
					default: withCtx(() => [createTextVNode(toDisplayString(__props.section.label), 1)]),
					_: 1
						...
						return openBlock(), createBlock(unref(SidebarMenuItem_default), { key: item.title }, {
							default: withCtx(() => [createVNode(unref(SidebarMenuButton_default), {
								...
								default: withCtx(() => [createVNode(unref(link_default), { href: item.href }, {
									default: withCtx(() => [item.icon ? (openBlock(), createBlock(resolveDynamicComponent(item.icon), { key: 0 })) : createCommentVNode("", true), createBaseVNode("span", null, toDisplayString(item.title), 1)]),
									_: 2
								}, 1032, ["href"])]),
								_: 2
					...
					}), 128)), (openBlock(true), createElementBlock(Fragment, null, renderList(__props.section.groups, (group) => {
						return openBlock(), createBlock(NavCollapsible_default, {
							key: group.title,
							group
						}, null, 8, ["group"]);
					}), 128))]),
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DropdownMenuLabel_default$1), mergeProps({
				...
				"data-inset": __props.inset ? "" : void 0
			}, unref(forwardedProps), { class: unref(cn)("px-2 py-1.5 text-sm font-medium data-[inset]:pl-8", props.class) }), {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 16, ["data-inset", "class"]);
		};
...
var DropdownMenuSeparator_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		...
		const delegatedProps = reactiveOmit(props, "class");
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(DropdownMenuSeparator_default$1), mergeProps({ "data-slot": "dropdown-menu-separator" }, unref(delegatedProps), { class: unref(cn)("bg-border -mx-1 my-1 h-px", props.class) }), null, 16, ["class"]);
		};
	}
});
//#endregion
...
var _hoisted_1$5 = { class: "grid flex-1 text-left text-sm leading-tight" };
var _hoisted_2$3 = { class: "truncate font-medium" };
var _hoisted_3$2 = {
	key: 0,
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createVNode(unref(Avatar_default), { class: "h-8 w-8 overflow-hidden rounded-lg" }, {
				default: withCtx(() => [createVNode(unref(AvatarFallback_default), { class: "rounded-lg text-black dark:text-white" }, {
					default: withCtx(() => [createTextVNode(toDisplayString(unref(getInitials)(__props.user.name)), 1)]),
					_: 1
				})]),
				_: 1
			}), createBaseVNode("div", _hoisted_1$5, [createBaseVNode("span", _hoisted_2$3, toDisplayString(__props.user.name), 1), __props.showEmail ? (openBlock(), createElementBlock("span", _hoisted_3$2, toDisplayString(__props.user.email), 1)) : createCommentVNode("", true)])], 64);
		};
	}
});
//#endregion
//#region resources/js/components/UserMenuContent.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$4 = { class: "flex items-center gap-2 px-1 py-1.5 text-left text-sm" };
var _hoisted_2$2 = {
	key: 0,
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [
				createVNode(unref(DropdownMenuLabel_default), { class: "p-0 font-normal" }, {
					default: withCtx(() => [createBaseVNode("div", _hoisted_1$4, [createVNode(UserInfo_default, {
						user: __props.user,
						"show-email": true
					}, null, 8, ["user"])])]),
					_: 1
				...
				createVNode(unref(DropdownMenuGroup_default), null, {
					default: withCtx(() => [
						createVNode(unref(DropdownMenuItem_default), { onClick: _cache[0] || (_cache[0] = ($event) => unref(updateAppearance)("light")) }, {
							default: withCtx(() => [
								createVNode(unref(Sun), { class: "mr-2 h-4 w-4" }),
								_cache[3] || (_cache[3] = createTextVNode(" Light ", -1)),
								unref(appearance) === "light" ? (openBlock(), createElementBlock("span", _hoisted_2$2, "✓")) : createCommentVNode("", true)
							]),
							_: 1
						}),
						createVNode(unref(DropdownMenuItem_default), { onClick: _cache[1] || (_cache[1] = ($event) => unref(updateAppearance)("dark")) }, {
							default: withCtx(() => [
								createVNode(unref(Moon), { class: "mr-2 h-4 w-4" }),
								_cache[4] || (_cache[4] = createTextVNode(" Dark ", -1)),
								unref(appearance) === "dark" ? (openBlock(), createElementBlock("span", _hoisted_3$1, "✓")) : createCommentVNode("", true)
							]),
							_: 1
						}),
						createVNode(unref(DropdownMenuItem_default), { onClick: _cache[2] || (_cache[2] = ($event) => unref(updateAppearance)("system")) }, {
							default: withCtx(() => [
								createVNode(unref(Monitor), { class: "mr-2 h-4 w-4" }),
								_cache[5] || (_cache[5] = createTextVNode(" System ", -1)),
								unref(appearance) === "system" ? (openBlock(), createElementBlock("span", _hoisted_4, "✓")) : createCommentVNode("", true)
							]),
							_: 1
						})
					]),
				...
				createVNode(unref(DropdownMenuItem_default), { "as-child": true }, {
					default: withCtx(() => [createVNode(unref(link_default), {
						...
						default: withCtx(() => [createVNode(unref(LogOut), { class: "mr-2 h-4 w-4" }), _cache[6] || (_cache[6] = createTextVNode(" Log out ", -1))]),
						_: 1
					})]),
					_: 1
				})
					...
					default: withCtx(() => [createVNode(unref(DropdownMenu_default), null, {
						default: withCtx(() => [createVNode(unref(DropdownMenuTrigger_default), { "as-child": "" }, {
							default: withCtx(() => [createVNode(unref(SidebarMenuButton_default), {
								...
								default: withCtx(() => [createVNode(UserInfo_default, { user: unref(user) }, null, 8, ["user"]), createVNode(unref(ChevronsUpDown), { class: "ml-auto size-4" })]),
								_: 1
							})]),
							_: 1
							...
							default: withCtx(() => [createVNode(UserMenuContent_default, { user: unref(user) }, null, 8, ["user"])]),
							_: 1
						}, 8, ["side"])]),
						_: 1
					})]),
...
var _hoisted_1$3 = { class: "flex aspect-square size-8 items-center justify-center rounded-md bg-sidebar-primary text-sidebar-primary-foreground" };
//#endregion
//#region resources/js/components/AppLogo.vue
var AppLogo_default = /* @__PURE__ */ defineComponent({
	__name: "AppLogo",
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createBaseVNode("div", _hoisted_1$3, [createVNode(AppLogoIcon_default, { class: "size-5 fill-current text-white dark:text-black" })]), _cache[0] || (_cache[0] = createBaseVNode("div", { class: "ml-1 grid flex-1 text-left text-sm" }, [createBaseVNode("span", { class: "mb-0.5 truncate leading-tight font-semibold" }, "Inertia Kitchen Sink")], -1))], 64);
		};
	}
});
//#endregion
			...
			groups: [
				{
					...
					items: [
						...
						{
							title: "File Uploads",
							href: "/features/forms/file-uploads"
						},
						{
							title: "Validation",
							href: "/features/forms/validation"
						},
						{
							title: "Precognition",
							href: "/features/forms/precognition"
						},
						{
						...
						{
							title: "Dotted Keys",
							href: "/features/forms/dotted-keys"
						}
					]
				},
				{
				...
				},
				{
					...
					items: [
						...
						{
							title: "Polling",
							href: "/features/data-loading/polling"
						},
						{
							title: "Prop Merging",
				...
				},
				{
					...
					items: [
						{
							title: "Remember",
							href: "/features/state/remember"
						},
						{
							title: "Flash Data",
							href: "/features/state/flash-data"
						},
						{
							title: "Shared Props",
							href: "/features/state/shared-props"
						}
					]
				},
				{
			...
			return openBlock(), createElementBlock(Fragment, null, [createVNode(unref(Sidebar_default), {
				...
				default: withCtx(() => [
						...
						default: withCtx(() => [createVNode(unref(SidebarMenu_default), null, {
							default: withCtx(() => [createVNode(unref(SidebarMenuItem_default), null, {
								default: withCtx(() => [createVNode(unref(SidebarMenuButton_default), {
									...
									default: withCtx(() => [createVNode(unref(link_default), { href: "/dashboard" }, {
					...
					createVNode(unref(SidebarContent_default), null, {
						default: withCtx(() => [createVNode(NavSection_default, {
							section: crmSection,
							items: crmNavItems
						}), createVNode(NavSection_default, { section: featuresSection })]),
						_: 1
					}),
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", {
				...
				class: normalizeClass(unref(cn)("inline-flex items-center gap-1.5", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createBlock(unref(Primitive), {
				...
				as: __props.as,
				"as-child": __props.asChild,
				class: normalizeClass(unref(cn)("hover:text-foreground transition-colors", props.class))
			}, {
				default: withCtx(() => [renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 8, [
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("ol", {
				...
				class: normalizeClass(unref(cn)("text-muted-foreground flex flex-wrap items-center gap-1.5 text-sm break-words sm:gap-2.5", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("span", {
				...
				"aria-disabled": "true",
				"aria-current": "page",
				class: normalizeClass(unref(cn)("text-foreground font-normal", props.class))
			}, [renderSlot(_ctx.$slots, "default")], 2);
		};
	}
});
	...
	setup(__props) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("li", {
				...
				role: "presentation",
				"aria-hidden": "true",
				class: normalizeClass(unref(cn)("[&>svg]:size-3.5", props.class))
...
var _hoisted_1$2 = { class: "flex h-16 shrink-0 items-center gap-2 border-b border-sidebar-border/70 px-6 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12 md:px-4" };
...
var AppSidebarHeader_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("header", _hoisted_1$2, [createBaseVNode("div", _hoisted_2$1, [createVNode(unref(SidebarTrigger_default), { class: "-ml-1" }), __props.breadcrumbs && __props.breadcrumbs.length > 0 ? (openBlock(), createBlock(Breadcrumbs_default, {
				key: 0,
...
//#endregion
//#region resources/js/composables/useFlashToast.ts
var toasts = ref([]);
var nextId = 0;
...
function addToast(message, type = "success") {
	...
	setTimeout(() => dismissToast(id), 4e3);
}
function useFlashToast() {
	...
	onMounted(() => {
		removeListener = router.on("flash", (event) => {
			...
			if (!message) return;
			addToast(message, flash.type || "success");
		});
	});
	onUnmounted(() => {
		removeListener?.();
...
//#endregion
//#region resources/js/components/FlashToast.vue?vue&type=script&setup=true&lang.ts
var _hoisted_1$1 = { class: "fixed top-4 right-4 z-50 flex flex-col gap-2" };
var _hoisted_2 = { class: "flex-1" };
var _hoisted_3 = ["onClick"];
//#endregion
//#region resources/js/components/FlashToast.vue
var FlashToast_default = /* @__PURE__ */ defineComponent({
	__name: "FlashToast",
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", _hoisted_1$1, [createVNode(TransitionGroup, {
				...
				default: withCtx(() => [(openBlock(true), createElementBlock(Fragment, null, renderList(unref(toasts), (toast) => {
					return openBlock(), createElementBlock("div", {
						key: toast.id,
						class: normalizeClass(["flex max-w-sm min-w-64 items-center gap-2 rounded-lg border px-4 py-3 text-sm shadow-lg", {
					...
					}, [createBaseVNode("span", _hoisted_2, toDisplayString(toast.message), 1), createBaseVNode("button", {
...
var AppSidebarLayout_default = /* @__PURE__ */ defineComponent({
	...
	setup(__props) {
		useFlashToast();
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock(Fragment, null, [createVNode(AppShell_default, { variant: "sidebar" }, {
				default: withCtx(() => [createVNode(AppSidebar_default), createVNode(AppContent_default, {
					variant: "sidebar",
				...
				_: 3
			}), createVNode(FlashToast_default)], 64);
		};
	}
});
//#endregion
	...
	setup(__props) {
		return (_ctx, _cache) => {
			return openBlock(), createBlock(AppSidebarLayout_default, { breadcrumbs: __props.breadcrumbs }, {
				default: withCtx(() => [__props.subtitle ? (openBlock(), createElementBlock("div", _hoisted_1, toDisplayString(__props.subtitle), 1)) : createCommentVNode("", true), renderSlot(_ctx.$slots, "default")]),
				_: 3
			}, 8, ["breadcrumbs"]);
		};
	}
...
//#endregion
export { Building2 as i, addToast as n, X as r, AppLayout_default as t };
