...
public final class Resources {
    ...
    public static Map<String, Object> contact(Contact contact, Map<String, Object> organization) {
        var map = new LinkedHashMap<String, Object>();
    ...
    public static Map<String, Object> note(Note note, Map<String, Object> contact, Map<String, Object> user) {
        var map = new LinkedHashMap<String, Object>();
        map.put("id", note.id);
