 ...
 * {@code DemoSecurityConfig}, with owner-only user management via
 * {@code @PreAuthorize} on {@code UsersController}): anonymous HTML visits
 * are redirected to the login page while anonymous Inertia visits receive
 * {@code 409} with {@code X-Inertia-Location}.</p>
 */
@Component
