package io.github.dg.quarkus.inertia.qute;
...
import io.github.dg.quarkus.inertia.spi.JsonProvider;
...
public class QuteSerializer {
    ...
    public Uni<String> serialize(PageObject page) {
        return Uni.createFrom().item(() -> {
            if (!io.github.dg.quarkus.inertia.internal.RawJsonUnwrapper.containsRawJson(page.props())) {
                return jsonProvider.toJson(page);
            }
            var unwrapped = io.github.dg.quarkus.inertia.internal.RawJsonUnwrapper.unwrap(page.props());
