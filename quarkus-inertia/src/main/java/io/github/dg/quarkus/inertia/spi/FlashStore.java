 ...
 * page is rendered).
 *
 * <p>The default implementation stores flash data in the Vert.x session
 * ({@code VertxSessionFlashStore}); implement this interface as a CDI bean
 * to provide a different backend.</p>
 */
