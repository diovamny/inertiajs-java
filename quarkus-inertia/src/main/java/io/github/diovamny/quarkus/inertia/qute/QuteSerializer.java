package io.github.diovamny.quarkus.inertia.qute;
...
public class QuteSerializer {
    ...
    public Uni<String> serialize(PageObject page) {
        return Uni.createFrom().item(() -> {
            if (!io.github.diovamny.quarkus.inertia.internal.RawJsonUnwrapper.containsRawJson(page.props())) {
                return jsonProvider.toJson(page);
            }
            var unwrapped = io.github.diovamny.quarkus.inertia.internal.RawJsonUnwrapper.unwrap(page.props());
