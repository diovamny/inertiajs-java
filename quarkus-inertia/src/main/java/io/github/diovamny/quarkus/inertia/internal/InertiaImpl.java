package io.github.diovamny.quarkus.inertia.internal;
...
public class InertiaImpl implements Inertia {
    ...
    @Inject
    jakarta.enterprise.inject.Instance<io.github.diovamny.quarkus.inertia.spi.InertiaSharedDataContributor> sharedContributors;
