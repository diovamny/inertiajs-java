...
1. Search existing issues and discussions — your question may be answered.
2. State the adapter (`spring-inertia` / `quarkus-inertia`), its version, the
   Java version and a minimal reproduction (controller + request + page).
3. Do not paste secrets, credentials, tokens or personal data.
